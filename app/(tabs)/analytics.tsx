...
export default function AnalyticsScreen() {
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: bgColor }]} contentContainerStyle={{paddingBottom: 100}}>
      <View style={styles.headerRow}>
        <Text style={[styles.title, { color: txtColor }]}>Insights</Text>
...
const styles = StyleSheet.create({
  ...
  sectionTitleSmall: { fontSize: 16, fontWeight: '800', color: '#fff' },
  ...
  breakdownName: { fontSize: 16, fontWeight: '700', color: '#fff' },
  ...
  tMerchant: { fontSize: 15, fontWeight: '700', color: '#fff' },
